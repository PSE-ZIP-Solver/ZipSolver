...

    {
        ...
        config: {
            ...
            walls: [
                ...
                // Horizontal walls between rows 1 and 2
                { neighborA: [1, 0], neighborB: [2, 0] },
                { neighborA: [1, 1], neighborB: [2, 1] },
                { neighborA: [1, 3], neighborB: [2, 3] },
                { neighborA: [1, 4], neighborB: [2, 4] },

                // Vertical wall next to waypoint 6
                { neighborA: [2, 2], neighborB: [2, 3] },

                // Horizontal walls between rows 2 and 3
                { neighborA: [2, 1], neighborB: [3, 1] },
                { neighborA: [2, 2], neighborB: [3, 2] },
                { neighborA: [2, 4], neighborB: [3, 4] },
                { neighborA: [2, 5], neighborB: [3, 5] },

                // Horizontal walls between rows 3 and 4
                { neighborA: [3, 0], neighborB: [4, 0] },
                { neighborA: [3, 1], neighborB: [4, 1] },

                // Vertical wall next to waypoint 7
                { neighborA: [4, 4], neighborB: [4, 5] },

                // Horizontal walls between rows 4 and 5
