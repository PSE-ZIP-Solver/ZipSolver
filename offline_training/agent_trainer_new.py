    ...
    def train(self) -> RLAgent:
        ...
        if self.loadExistingModel and modelFile.exists():
            ...
            agent = RLAgent(
                ...
                exploration_initial_eps=0.65,     # Initial probability of choosing a random action.
...
if __name__ == "__main__":
    ...
    TRAINING_BOARDS_PATH = ("offline_training/training_boards/04-8x8.pkl")

    USE_SAVED_EVALUATION_BOARDS = False
    EVALUATION_BOARDS_PATH = "offline_training/evaluation_boards/04-8x8.pkl"
    ...
    trainer = AgentTrainer(
        ...
        modelPath="offline_training/trained_models/04-8x8.zip",
